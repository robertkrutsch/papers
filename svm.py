...
for i in range(1, Config.nr_users + 1, 1):
    ...
    print("Statistic on usr"+str(i)+" (false_negative,false_positive):",false_negative,false_positive)


"""
    Second generate the features for the validaion data.
"""
...
for i in range(1, Config.nr_users + 1, 1):
    ...
    s = classifiers[i-1].decision_function(X) #evaluate on the validation dataset
